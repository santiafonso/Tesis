...
barridos de mascara (archive/dip_sweep_64/ y archive/dip_sweep_128/, antes
results_gris_{64,128}/) y el diagrama del modelo del continuo. Tambien produce la
figura resumen sweep_summary.png.
...
def main():
    ...
    R = "archive/dip_sweep_128"  # antes results_gris_128/ (movido en la reorg)
    ...
    add_params_slide(
        ...
        [
            ("Script", "dip/phase_diagram.py  (NUM_XI = NUM_ELL = 128)"),
    ...
    add_code_slide(
        prs,
        "El codigo que calcula MAE / PSNR / SSIM  (dip/restoration.py + dip/metrics.py)",
